...
@Component({
  selector: 'app-add-congie',
  templateUrl: './add-congie.component.html',
  styleUrls: ['./add-congie.component.scss']
})
export class AddCongieComponent implements OnInit {
  angForm: FormGroup;
  isLogged: any;
  ...
  postdata(f: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.dataService.demandeCongie(f).subscribe(
          (data) => {
